...
public class DanhSachSinhVien extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getData();
        sinhVienArrayList.add(new SinhVien("1","2050531200317","Trần Anh Tuấn" , "20T3" , "Công nghệ Thông tin","Công nghệ số"));
        sinhVienArrayList.add(new SinhVien("2","2050531200318","Trần Anh Tín" , "20T3" , "Công nghệ Thông tin","Công nghệ số"));
        sinhVienArrayList.add(new SinhVien("3","2050531200319","Trần Anh Tâm" , "20T3" , "Công nghệ Thông tin","Công nghệ số"));
