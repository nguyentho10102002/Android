...
class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UsersAdapterVh> implements Filterable {
    ...
    public UsersAdapter.UsersAdapterVh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UsersAdapterVh(LayoutInflater.from(context).inflate(R.layout.row_user,null));
    }
